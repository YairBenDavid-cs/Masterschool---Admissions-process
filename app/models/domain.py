...
class User(BaseModel):
    ...
    Attributes:
        ...
        step_name (Optional[str]): The ID of the step the user is currently facing.
        task_name (Optional[str]): The ID of the task the user needs to complete next.
    ...
    # State tracking
    step_name: Optional[str] = Field(default=None, description="Current step ID")
    task_name: Optional[str] = Field(default=None, description="Current task ID")
